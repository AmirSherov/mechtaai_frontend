        ...
        <>
            ...
            <div className="md:hidden fixed top-4 left-4 z-50">
                <button
                    ...
                    className="w-10 h-10 gradient-orange rounded-lg flex items-center justify-center shadow-lg transition-transform active:scale-95"
                >
                    {isOpen ? (
            ...
            {/* Sidebar */}
            <div className={`
                fixed inset-y-0 left-0 w-72 bg-[#0a0a0a] border-r border-[#333] z-50 md:hidden 
