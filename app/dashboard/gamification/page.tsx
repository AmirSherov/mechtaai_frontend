    ...
    return (
        <div className="min-h-screen p-4 md:p-8 space-y-8 max-w-7xl mx-auto">
            ...
            <div>
                ...
                <p className="text-gray-400">Отслеживайте свой прогресс и достигайте новых высот</p>
            </div>
            ...
            <div className="flex border-b border-white/10">
                <button
                    ...
                    className={`pb-4 px-6 text-sm font-medium transition-colors relative ${activeTab === 'achievements' ? 'text-white' : 'text-gray-500 hover:text-gray-300'
                        }`}
                >
                    Достижения
                ...
                <button
                    ...
                    className={`pb-4 px-6 text-sm font-medium transition-colors relative ${activeTab === 'leaderboard' ? 'text-white' : 'text-gray-500 hover:text-gray-300'
                        }`}
                >
                    Лидерборд
